...
# Libraries
from symbolic.models.__model__ import __Model__, replace_variables, equate_to, convert_data, sparsen_data
...
class Model(__Model__):
    ...
    def initialise(self, **settings):
        ...
        self.set_fields(["strain", "strain_rate", "temperature", "stress"])
    ...
    def fit(self, data_list:list) -> None:
        ...
        * `data_list`: List of dictionaries containing data
        ...
        input_data = convert_data(data_list, ["strain", "strain_rate", "temperature"])
    ...
    def predict(self, data_list:list) -> list:
        ...
        * `data_list`: List of dictionaries containing data
        ...
        for data in data_list:
            input_data = convert_data([data], ["strain", "strain_rate", "temperature"])
